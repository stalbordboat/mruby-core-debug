...
void mrb_init_metaprog(mrb_state*);
void mrb_init_binding(mrb_state*);
void mrb_init_eval(mrb_state*);
void mrb_init_objectspace(mrb_state*);
...
mrb_init_core(mrb_state *mrb)
{
  ...
  mrb_init_metaprog(mrb); DONE;
  mrb_init_binding(mrb); DONE;
  mrb_init_eval(mrb); DONE;
  mrb_init_objectspace(mrb); DONE;
}
